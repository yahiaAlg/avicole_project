...
3. [Phase 1 — Achats Intrants (BL + Facture + Règlement)](#3-phase-1--achats-intrants)
4. [Phase 2 — Ouverture du Lot d'Élevage](#4-phase-2--ouverture-du-lot-délevage)
5. [Phase 3 — Suivi Quotidien (Mortalités + Consommations)](#5-phase-3--suivi-quotidien)
6. [Phase 4 — Abattage & Production](#6-phase-4--abattage--production)
7. [Phase 5 — Ajustement de Stock](#7-phase-5--ajustement-de-stock)
8. [Phase 6 — Vente & Livraison Client](#8-phase-6--vente--livraison-client)
9. [Phase 7 — Dépenses Opérationnelles](#9-phase-7--dépenses-opérationnelles)
10. [Compte de résultat du lot](#10-compte-de-résultat-du-lot)
11. [Règles métier activées](#11-règles-métier-activées)
...
```mermaid
flowchart TD
    SEED([🌱 seed_db --mode minimal]) --> PHASE1
...
mindmap
  root((seed_db\n--mode minimal))
    ...
    Fournisseurs x5
      ONAB Setifien — Aliments
      CCA Blida — Poussins
      Sanofi Algérie — Médicaments
      Proxi-Aliments Boumerdès
      Techno-Avicole Services
    Clients x5
      Marché de Gros Setifien
      Restaurant Le Palmier
      Boucherie Amrane & Fils
      Épicerie Centrale Azazga
      Grossiste Alger Sud
    Bâtiments x4
      Bâtiment A cap. 5 000
      Bâtiment B cap. 4 000
      Bâtiment C cap. 6 000
      Dépôt Aliments
    Intrants x10
      ALIM-DEM / ALIM-CRO / ALIM-FIN
      POUSS-R308 / POUSS-C500
      MED-NEWC / MED-GCOR
      MED-AMOX / MED-VITA
      AUT-LITIERE
    Produits Finis x5+
...
> ⚠️ **Stock = zéro partout**. Aucun BL, aucun lot, aucune facture, aucun mouvement de stock. Tout doit être saisi via l'interface.
...
> **Point de départ** : `seed_db --mode minimal` → master data présente, zéro opérationnel.
