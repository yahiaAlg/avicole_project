...
class CompanyInfo(models.Model):
    ...
    telephone_2 = models.CharField(max_length=30, verbose_name="Téléphone 2", blank=True)
    ...
    nis = models.CharField(
        max_length=50, verbose_name="NIS (Numéro d'identification statistique)", blank=True
    )
    logo = models.ImageField(
        upload_to="company/", verbose_name="Logo", blank=True, null=True
    )
    pied_de_page = models.TextField(
        verbose_name="Pied de page des documents", blank=True,
