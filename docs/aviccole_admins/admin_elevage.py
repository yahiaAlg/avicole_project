...
from elevage.resources import LotElevageResource, MortaliteResource, ConsommationResource
...
class LotElevageAdmin(ImportExportModelAdmin):
    ...
    list_display = (
        "designation", "batiment", "statut_badge",
        "date_ouverture", "date_fermeture",
        "nombre_poussins_initial", "effectif_vivant_display",
        "taux_mortalite_display", "duree_jours",
    )
    ...
    readonly_fields = (
        ...
        "total_mortalite", "effectif_vivant_display",
        "taux_mortalite_display", "duree_jours",
        "consommation_totale_aliment", "cout_total_intrants",
    )
    ...
    fieldsets = (
        ...
        ("Poussins", {
            "fields": (
                "nombre_poussins_initial", "fournisseur_poussins",
                "bl_fournisseur_poussins", "souche", "batiment",
            ),
        }),
    ...
    def get_readonly_fields(self, request, obj=None):
        ...
        if obj and obj.statut == LotElevage.STATUT_FERME:
            base += [
                "designation", "batiment", "statut",
                "date_ouverture", "date_fermeture",
                "nombre_poussins_initial", "fournisseur_poussins",
                "bl_fournisseur_poussins", "souche",
            ]
        return base
