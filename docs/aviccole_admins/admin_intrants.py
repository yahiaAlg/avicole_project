...
from intrants.models import CategorieIntrant, TypeFournisseur, Fournisseur, Batiment, Intrant
...
class FournisseurAdmin(ImportExportModelAdmin):
    ...
    list_display = (
        "nom", "type_principal", "wilaya", "telephone",
        "actif", "dette_globale_dzd", "acompte_disponible_dzd",
    )
    list_filter = ("actif", "type_principal", "wilaya")
    search_fields = ("nom", "nif", "rc", "telephone", "email")
    readonly_fields = ("created_at", "updated_at", "dette_globale_dzd", "acompte_disponible_dzd")
...
class IntrantAdmin(ImportExportModelAdmin):
    ...
    list_display = (
        ...
        "quantite_en_stock", "seuil_alerte", "statut_alerte", "actif",
    )
